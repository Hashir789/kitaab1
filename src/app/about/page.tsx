...
export const metadata: Metadata = {
  title: "About",
  description:
    "Learn about Kitaab - an Islamic deed tracking application inspired by the concept of Amaal Naama (Book of Deeds). Discover our mission to help Muslims track Hasanaat and Sayyi'aat for spiritual growth.",
  keywords: [
    "about Kitaab",
    "Islamic app",
    "Amaal Naama",
